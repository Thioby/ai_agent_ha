...
from custom_components.ai_agent_ha.core.agent import Agent
...
class TestGetEntityStateDelegatesToManager:
    ...
    def test_get_entity_state_lazy_init(self) -> None:
        ...
        with patch(
            "custom_components.ai_agent_ha.managers.entity_manager.EntityManager"
...
class TestCallServiceDelegatesToControl:
    ...
    async def test_call_service_lazy_init(self) -> None:
        ...
        with patch(
            "custom_components.ai_agent_ha.managers.control_manager.ControlManager"
...
class TestCreateAutomationDelegatesToManager:
    ...
    async def test_create_automation_lazy_init(self) -> None:
        ...
        with patch(
            "custom_components.ai_agent_ha.managers.automation_manager.AutomationManager"
...
class TestGetDashboardDelegatesToManager:
    ...
    async def test_get_dashboards_lazy_init(self) -> None:
        ...
        with patch(
            "custom_components.ai_agent_ha.managers.dashboard_manager.DashboardManager"
...
class TestRegistryOperations:
    ...
    def test_get_entities_by_area_lazy_init(self) -> None:
        ...
        with patch(
            "custom_components.ai_agent_ha.managers.registry_manager.RegistryManager"
