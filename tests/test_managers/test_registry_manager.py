...
class TestRegistryManager:
    ...
    def registry_manager(self, mock_hass, mock_registries):
        ...
        with patch(
            "custom_components.ai_agent_ha.managers.registry_manager.er.async_get"
        ) as mock_er, patch(
            "custom_components.ai_agent_ha.managers.registry_manager.dr.async_get"
        ) as mock_dr, patch(
            "custom_components.ai_agent_ha.managers.registry_manager.ar.async_get"
        ) as mock_ar:
            ...
            from custom_components.ai_agent_ha.managers.registry_manager import (
                RegistryManager,
            )
