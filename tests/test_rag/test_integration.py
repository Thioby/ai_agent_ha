...
class TestRAGManagerIntegration:
    ...
    async def test_full_rag_workflow(
        ...
        from custom_components.ai_agent_ha.rag.embeddings import OpenAIEmbeddings
...
class TestEventHandlerIntegration:
    ...
    async def test_event_handler_setup(self, hass, tmp_path):
        ...
        from custom_components.ai_agent_ha.rag.entity_indexer import EntityIndexer
        from custom_components.ai_agent_ha.rag.chroma_store import ChromaStore
...
class TestSemanticLearningIntegration:
    ...
    async def test_learning_persists_across_sessions(
        ...
        from custom_components.ai_agent_ha.rag.semantic_learner import SemanticLearner
        from custom_components.ai_agent_ha.rag.entity_indexer import EntityIndexer
